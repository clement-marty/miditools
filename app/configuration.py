...
class ConfigurationWindow(tk.Tk):
    ...
    def create_widgets(self) -> None:
        ...
        btn_channel.place(relx=0.1, rely=0.4, relwidth=0.4, relheight=0.1)
        ...
        btn_config.place(relx=0.6, rely=0.4, relwidth=0.4, relheight=0.1)

        self.text_area = scrolledtext.ScrolledText(self, wrap = tk.WORD, width=54, font = ("Calibri", 12), bg="#1e1e2f", fg="#f5f5f9")
        self.text_area.place(relx=0, rely=0.5, relwidth=1, relheight=0.5)
